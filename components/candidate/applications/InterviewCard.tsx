...
// InterviewCard.tsx — Client Component
// CSR: mengandung LiveCountdown yang butuh browser timer
...
import { Interview, IV_STATUS_MAP } from "./types";
import { getDayLabel, formatTime, isToday, getPlatformInfo } from "./utils";
...
export default function InterviewCard({ iv, index }: InterviewCardProps) {
  ...
  const platform =
    iv.type === "online" ? getPlatformInfo(iv.location) : null;

              ...
              <div className="relative flex-shrink-0">
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 0 20px rgba(16,185,129,0.2), inset 0 1px 0 rgba(255,255,255,0.08)",
                  }}>
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h1
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, #e8f0ec 0%, #10b981 60%, #06b6d4 100%)",
        ...
        {company && (
          <FadeIn delay={0.22}>
            <div className="rounded-[14px] p-4 flex items-center gap-4 mt-4 bg-[#0a0f0c] border border-emerald-500/12">
              ...
              <div className="text-[0.62rem] text-[#7a9585]/40 flex-shrink-0">

// @/components/hr/calendar/CalendarEventCard.tsx
// Avatar and EventCard — pure presentational, no data fetching
"use client";
      ...
      <div className="px-[10px] pt-[8px] pb-[6px] h-full flex flex-col">
        {compact ? (
          <div className="flex items-center gap-2 h-full">
            <Avatar
              name={interview.candidate_name || null}

// @/components/hr/calendar/CalendarDayView.tsx
// Day view calendar grid — CSR
"use client";

import { useMemo, useRef, useEffect } from "react";

import { sameDay } from "@/lib/helpers/hr/calendar";
import { Interview } from "@/types/calendar";
import { EventCard } from "./CalendarEventCard";
import { CELL_H, VISIBLE_HOURS } from "@/constants/calendar";
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            style={{
              background: isToday ? "rgba(99,102,241,0.018)" : "transparent",
            }}>
            {/* Hour lines */}
            {VISIBLE_HOURS.map((h) => (
              <div

// @/components/hr/calendar/CalendarMonthView.tsx
// Month view calendar grid — CSR
"use client";

import { STATUS_CFG } from "@/constants/calendar";
import { fmt12, getMonthGrid, sameDay } from "@/lib/helpers/hr/calendar";
            ...
            <div
              ...
              <div className="flex flex-col gap-[2px] overflow-hidden">
                {dayIvs.slice(0, 3).map((iv) => {
                  ...
                  const firstName = (iv.candidate_name ?? "").split(" ")[0];
                  return (
                    <button
                      key={iv.id}
                      onClick={(e) => {
                      ...
                      <span
                        ...
                        {fmt12(new Date(iv.scheduled_at))} {firstName}
                      </span>
                    </button>
                  );
                })}

...
function StageBadge({ status }: { status: string }) {
  ...
  return (
    <span
      className="inline-flex items-center gap-[5px] text-[11px] font-bold px-[9px] py-[4px] rounded-[6px]"
      style={{
        background: st.bg,
        color: st.color,
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 top-full mt-2 z-[500]"
            style={{
              width: 260,
              background: "#0d1510",
            ...
            <div
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-7 pr-3 py-[6px] rounded-[8px] text-[12px] outline-none"
                  style={{
                    background: "#141f19",
            ...
            <div className="overflow-y-auto py-1" style={{ maxHeight: 240 }}>
              {search === "" && (
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-[8px] text-[12px] font-semibold text-left transition-colors cursor-pointer"
                  style={{
                    background:
                      activeJob === "all"
              ...
              {search === "" && jobMetas.length > 0 && (
                <div
                  className="mx-3 my-1"
                  style={{ height: 1, background: "rgba(16,185,129,0.08)" }}
                />
              )}
              {filtered.length === 0 ? (
...
// ─────────────────────────────────────────────────────────────────────────────
// ACTION DROPDOWN — portal-based, tidak pernah ter-clip
// ─────────────────────────────────────────────────────────────────────────────
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-[9999] rounded-[10px] overflow-hidden w-[160px]"
            style={{
              top: pos.top,
              left: pos.left,
              background: "#141f19",
            ...
            {[
              ...
              <button
                ...
                className="flex items-center gap-2 w-full px-3 py-[9px] text-[12px] font-semibold text-left transition-colors"
                style={{ color }}
                onMouseEnter={(e) =>
...
// ─────────────────────────────────────────────────────────────────────────────
// PAGINATION — tanpa "Go to page" input
// ─────────────────────────────────────────────────────────────────────────────
function Pagination({
  page,
  total,
...
export default function CandidatesTable({
  ...
  // Job metas — derived dari candidates
  ...
  const jobMetas: JobMeta[] = uniqueJobs.map((job, i) => {
    ...
    const todayCount = jobCandidates.filter(
      (c) => (c as any).created_at && isToday((c as any).created_at),
    ).length;
    return {
      key: job,
      label: job,
  ...
  useEffect(() => {
    setPage(1);
  }, [search, activeJob, activeStatus, sortKey, sortDir]);
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-3 py-[7px] w-[200px] rounded-[9px] text-[13px] outline-none"
                  style={{
                    background: "#141f19",
                    border: "1px solid rgba(16,185,129,0.15)",
                    color: "#e8f0ec",
              ...
              {/* Filter */}
              <button
                className="flex items-center gap-2 px-3 py-[7px] rounded-[9px] text-[12px] font-semibold"
                style={{
                  background: "#141f19",
                  border: "1px solid rgba(16,185,129,0.15)",
                  color: "#7a9585",
              ...
              <div className="relative">
                <select
                  ...
                  className="pl-3 pr-8 py-[7px] rounded-[9px] text-[12px] outline-none cursor-pointer appearance-none font-semibold"
                  style={{
                    background: "#141f19",
                    border: "1px solid rgba(16,185,129,0.15)",
                    color: "#7a9585",
                      ...
                      style={{
                        background:
                          activeStatus === key
                            ? "rgba(16,185,129,0.2)"
                            : "rgba(16,185,129,0.06)",
                        color: activeStatus === key ? "#10b981" : "#7a9585",
                      }}>
                      {count}
                    </span>
                  </button>
                        ...
                        <motion.tr
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="text-[11px] text-[#7a9585]">
                                  {(c as any).email ??
                                    `${c.name.toLowerCase().replace(/\s+/, ".")}@gmail.com`}
                                </div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-4 py-3">
                            <span className="text-[12px] text-[#7a9585] font-mono">
                              {(c as any).phone ?? "+62 812 0000 0000"}
                            </span>
                          </td>
                          {/* Applied Date */}
                          <td className="px-4 py-3">

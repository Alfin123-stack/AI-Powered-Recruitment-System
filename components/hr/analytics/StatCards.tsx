...
// @/components/hr/analytics/StatCards.tsx
// 5 stat card di bagian overview — CSR (animasi framer-motion)

import { motion } from "framer-motion";
import { Users, Star, CheckCircle2, Brain, Briefcase, ArrowUpRight } from "lucide-react";
...
function StatCard({ icon: Icon, color, bg, value, label, sub, trend, delay = 0 }: StatCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -3, borderColor: T.cardBorderHover, transition: { duration: 0.2 } }}>
      {/* top accent line */}
      <div
      ...
      <div className="font-black text-[2.2rem] leading-none mb-1" style={{ color }}>
        {value}
      </div>
      <div className="text-[0.78rem] font-semibold" style={{ color: T.textPrimary }}>
        {label}
      </div>

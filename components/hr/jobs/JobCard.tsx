// @/components/hr/jobs/JobCard.tsx
// Pure display component — no state, no data fetching
// Rendered client-side karena butuh router & motion
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[0.65rem] font-semibold text-[#5a8070] uppercase tracking-[0.07em] truncate">
              {job.type}
              {!job.is_active && (
                <span className="ml-2 text-[#3d5a45]">· Ditutup</span>
              )}
            </p>
              ...
              <span className="text-[0.67rem] text-[#5a7868] font-medium">
                {job.applicantCount === 0
                  ...
                  : job.applicantCount === 1
                    ? "Match Score"
                    : `Avg Match Score · ${job.applicantCount} pelamar`}
              </span>
            </div>
            {job.applicantCount > 0 ? (
              <span

  ...
  return (
    <>
      ...
      <Link
        href="/login"
        className="
          hidden sm:block px-[13px] py-[7px] rounded-[9px]
      ...
      <Link
        href="/register"
        className="
          relative inline-flex h-9 rounded-[10px] overflow-hidden p-[1.5px] no-underline flex-shrink-0
      ...
      >
        ...
        <span
          className="
            relative z-10 inline-flex items-center gap-[6px] h-full px-[14px]
